...
upper =  \new Staff { 
	...
	b1 | % A sus2
	d'4. fis8~fis8 a4 cis'8 | % G maj7
	b8 cis'8 a8 fis8~ fis2 | %Dmaj6 D 
	%%
	cis'2. a4 | % Bsus2
	b4. b8~b2 | % A sus2
	d'4. fis8~fis8 a4 cis'8 | % G maj7
	b8 cis'8 a8 fis8~ fis2 | % d2 des:7sus4
	% Parte A 
	% ( D major ) VI - V - IV - I 
 	d'4. fis'8~fis'4  d'4 | % Bsus2
	e'1 | % A sus2
	g'4. b8~b8 d'4 fis'8 | % G maj7
	e'8 fis'8 d'8 b8~ b2 | %Dmaj6 D 
	%
	fis'4. fis'8~fis'4  d'4 |  % Bsus2
	e'1 |  % Asus2
	g'4. b8~b8 d'4 fis'8  |   % Gmaj7
	e'8 fis'8 d'8 b8  d'8  g' fis'8 f'8~|   % d2 des:7sus4
	% Parte B
	...
	\times 2/3 { b'2 d''2 fis''4 d''4 } | % Bm4
