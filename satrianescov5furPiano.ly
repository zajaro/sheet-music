...
lower =  \new Staff {
	...
	#(set-octavation -1) 
	% Intro
	b,8\accent  b,4 fis8\accent~ fis4 b,4\accent  | % Bsus2
	a,8\accent e4  a,8\accent~ a,4 e4\accent  | % Asus2
	g,8\accent g,4  d8\accent~ d4 g,4\accent  | % G
	d8\accent d4  a8\accent~  a4 a4\accent | % D6 D
	% Parte A
	b,8\accent  b,4 fis8\accent~ fis4 b,4\accent  | % Bsus2
	a,8\accent e4  a,8\accent~ a,4 e4\accent  | % Asus2
	g,8\accent g,4  d8\accent~ d4 g,4\accent  | %G
	...
	a,8\accent e4  a,8\accent~ a,4 e4\accent  | % Asus2
	g,8\accent g,4  d8\accent~ d4 g,4\accent  | % G
	d8\accent d4 des8\accent~ des4  des4\accent | % D Db7 
	% Parte B
