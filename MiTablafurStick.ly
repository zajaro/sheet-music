...
upperuno =  \new Staff { 
	...
	<a' >8 <a' >16 <a' >16~<a' >16 <e' >8 <fis' >16~<fis' >2 |
	%Parte B
	<cis'' >2. ^\markup {Parte B} <b' >8 <cis'' >8 |
	<d'' >2. <d'' >4 |
	<cis'' >2. <b' >8 <cis'' >8 |
	<d'' >2. <d'' >4 |
	<cis'' >2. <b' >8 <cis'' >8 |
...
uppercuaderno =  \new Staff { 
	...
	r1*4 |
	%Parte A
	r8 ^\markup {Parte A} < cis'>8~< cis'>8 < b>8 < gis>8. < gis>16~< gis>8  < e>8 |
	< fis>8 < fis >16 < fis>16~< fis>16 < gis>8 < cis>16~< cis>2 |
	r8 < cis'>8~< cis'>8 < b>8 < gis>8. < gis>16~< gis>8  < gis>8 |
	< e'>8 < e'>16 < e'>16~< e'>16 < b>8 < cis'>16~< cis'>2 |
	r8 < cis'>8~< cis'>8 < b>8 < gis>8. < gis>16~< gis>8  < e>8 |
	< fis>8 < fis >16 < fis>16~< fis>16 < gis>8 < cis>16~< cis>2 |
	r8 < cis'>8~< cis'>8 < b>8 < gis>8. < gis>16~< gis>8  < gis>8 |
	< e'>8 < e'>16 < e'>16~< e'>16 < b>8 < cis'>16~< cis'>2 |
	%Parte B
	< gis'>2. ^\markup {Parte B} < fis'>8 < gis'>8 |
	< a'>2. < a'>4 |
	< gis'>2. < fis'>8 < gis'>8 |
	< a'>2. < a'>4 |
	< gis'>2. < fis'>8 < gis'>8 |
	< a'>2. < a'>4 |
	< gis'>8. < fis'>16~< fis'>8 < fis'>8~< fis'>2 |
	< fis'>8. < fis'>16~< fis'>8 < fis'>8~< fis'>2 |
	%Parte C
	< cis'>4. ^\markup {Parte C}< b>8~< b>4 < gis>4 |
	< a>4. < gis>8~< gis>4 < fis>16 < e>8. |
	< fis>4. < gis>16 < e>16~ < e>2 |
	r1 |
	< cis'>4. < b>8~< b>4 < gis>4 |
	< a>4. < gis>8~< gis>4 < fis>16 < e>8. |
	< fis>4. < gis>16 < e>16~ < e>2 |
...
percbasea = \drummode { 
			<bda hh>8.  <bda >16 <hho>8 <sna >8 <hho>8 <bda >8 <sna hh>16 <sna >16 r8 |
			<bda hh>8.  <bda >16 <hho>8 <sna >8 <hho>8 <bda >8 <sna hh>8  r8 |
}

percbaseb = \drummode { 
			<bda cyms>8. <sna >16 <rb>8 <bda >8 <rb>8 <bd>8 <sna rb>4 |
...
ParteB = {
		\percbaseb \percbaseb \percbaseb \percbaseb
}
ParteC = {
		\percbasec \percbasecb \percbasec \percbasecb \percbasec \percbasecb \percbasec \percbasecb
}
...
\score { 
	...
	%	\upper
		...
		\lowertwo
                \new DrumStaff <<
                       \new DrumVoice { \Intro \ParteA \ParteB \ParteC }
                               >>
